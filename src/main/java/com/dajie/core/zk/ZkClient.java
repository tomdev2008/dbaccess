...
public class ZkClient {
    ...
    public static ZkClient getInstance(String zkAddress) throws ZookeeperException {
        ...
        synchronized (zkClientMapGate) {
            ...
            if (zkClient != null) {
                ...
                try {
                    ...
                    logger.error("Zkclient.getInstance(String) zkAddress:" + newZkAddress);
                }
            }
        }
        return zkClient;
    ...
    private boolean initialize() throws ZookeeperException {
        ...
        if (!isValid()) {
            throw new ZookeeperException("ZkManagerFactory.get return null\t zkAddress:"
                    + zkAddress);
        }
    ...
    public void addZnodeListener(ZNodeListener listener) {
        try {
            ...
            List<ZNodeListener> listenerList = listeners.get(listener.getZNode());
